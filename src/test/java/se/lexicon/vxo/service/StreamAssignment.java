...
public class StreamAssignment {
    ...
    public void task3(){
        ...
        //Write code here
        //amount= people.stream().findAny().filter(person -> person.getLastName("Andersson")).count();
    ...
    public void task4(){
        ...
        //Write code here
        List<Person> allFemales = people.stream().filter(person -> person.getGender().equals(Gender.FEMALE)).collect(Collectors.toList());
        females = allFemales;
        females.addAll(allFemales);
    ...
    public void task5(){
        ...
        //Write code here
        dates = new TreeSet<>();
        Set<LocalDate> peoplesBirthDate = new TreeSet<>();
        //peoplesBirthDate.add(people.stream().forEach(person -> person.getDateOfBirth()));
